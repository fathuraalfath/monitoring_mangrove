    ...
    <div class="col-12">
        ...
        <!-- /.card-header -->
            <div class="card-body" style="align-content: center;">
                ...
                {{-- button print --}}
                <a href="/user/print" target="_blank" class="btn btn-warning btn-sm">Print to PDF</a> <br><br>
                    ...
                    <table id="example" class="table display nowrap dataTable table-bordered table-hover" style="width: 100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/user/download/{{ urlencode($data->file_shp) }}" class="btn btn-sm btn-primary fa fa-file"> Unduh</a>
                                </td>
                                {{-- <td>
